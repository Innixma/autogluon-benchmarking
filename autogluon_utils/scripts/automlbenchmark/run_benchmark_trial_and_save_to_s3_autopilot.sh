...
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_christine_config_small_accuracy
# python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_cnae-9_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_credit-g_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_dilbert_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_fabert_config_small_accuracy

aws s3 cp results s3://$OUTPUT_BUCKET/$OUTPUT_PREFIX/$OUTPUT_SUFFIX/ --recursive
aws s3 cp logs s3://$OUTPUT_BUCKET/$OUTPUT_PREFIX/$OUTPUT_SUFFIX/ --recursive

python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_jasmine_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_kc1_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_kr-vs-kp_config_small_accuracy

aws s3 cp results s3://$OUTPUT_BUCKET/$OUTPUT_PREFIX/$OUTPUT_SUFFIX/ --recursive
aws s3 cp logs s3://$OUTPUT_BUCKET/$OUTPUT_PREFIX/$OUTPUT_SUFFIX/ --recursive

python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_mfeat-factors_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_phoneme_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_segment_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_sylvine_config_small_accuracy

aws s3 cp results s3://$OUTPUT_BUCKET/$OUTPUT_PREFIX/$OUTPUT_SUFFIX/ --recursive
aws s3 cp logs s3://$OUTPUT_BUCKET/$OUTPUT_PREFIX/$OUTPUT_SUFFIX/ --recursive

python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_vehicle_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_adult_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_Amazon_employee_access_config_small_accuracy
python ~/workspace/automlbenchmark/runbenchmark.py AutoPilot automl_APSFailure_config_small_accuracy
